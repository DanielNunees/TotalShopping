...
<div data-role="footer"  data-position="fixed" data-tap-toggle="false" data-id="f1"  data-theme="a" >
  <div data-role="navbar">
    <ul>
      <li><a href="http://127.0.1.1/app/view/home.php" class="ui-btn-active ui-state-persist" data-transition="slide" data-icon="grid"  data-direction="reverse"></a></li>
      <li><a href="http://127.0.1.1/app/view/cart.php" data-transition="slide"  data-direction="reverse"  data-icon="shop" ></a></li>
      <li><a href="#" data-transition="slide" data-direction="reverse"  data-icon="search" ></a></li>
      <li><a href="http://127.0.1.1/app/view/sig_in.php" data-transition="slide"  data-icon="user"></a></li>
    </ul>
  </div>
</div>