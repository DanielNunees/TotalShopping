  ...
  <div data-role="page">
    <header data-role="header">
      ...
      <div data-role="navbar">
        <ul>
          <li><a href="<?php echo 'http://127.0.1.1/app/view/departament.php?id='.$id.'&categoria='.$categories_id[$cate]?>"><?php echo $product['name']; ?></a></li>
        </ul>
      </div>
      <div class="container home-color"  >
            <a class="nounderline " href="<?php echo 'http://127.0.1.1/app/view/departament.php?id='.$id.'&categoria='.$categories_id[$cate]?>">
