    ...
    <section>
      ...
      <?php  if(isset($products)) {  ?>
        ...
        <div  class=" container home-color"  >
          <a data-transition="slide" class="nounderline " href="<?php echo SERVER ?>'/app/TotalShopping/www/view/departament.php?id='.$id.'&categoria='.$categories_id[$cate]?>">
                     ...
                     <?php $parcel=10; ?>
                      <div class="col-xs-4 col-sm-4" style="padding-right: 2px; padding-left: 2px">
                              <div class="thumbnail box-shadow--2dp"   >
                                  <a class="nounderline" href="<?php echo SERVER.'/app/TotalShopping/www/view/product.php?id='.$product['produtos'][$i]['id'];?>" data-transition="slide" >
                                      <?php if(isset($product['produtos'][$i]['image'])){ ?>
                                          <img src="<?php echo SERVER.'/prestashop'.$product['produtos'][$i]['image']?>">
                                      <?php } else{?>
...
<?php  $cate++;}  ?>
      ...
      <a href="<?php echo SERVER.'/app/TotalShopping/www/view/home.php'?>">
