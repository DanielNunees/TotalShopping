...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
        ...
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'js/ngCart-master/template/ngCart/addtocart.html';
                } else {
    ...
    .directive('ngcartCart', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'js/ngCart-master/template/ngCart/cart.html';
                } else {
                    return attrs.templateUrl;
                }
            },
    ...
    .directive('ngcartSummary', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'js/ngCart-master/template/ngCart/summary.html';
                } else {
                    return attrs.templateUrl;
                }
            }
    ...
    .directive('ngcartCheckout', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'js/ngCart-master/template/ngCart/checkout.html';
                } else {
                    return attrs.templateUrl;
                }
            }
